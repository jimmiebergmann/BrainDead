#ifndef __BRAINDEAD_VERTEX_OBJECT_OGL_HPP__
#define __BRAINDEAD_VERTEX_OBJECT_OGL_HPP__
...
namespace BD
{
	...
	public:
		...
		virtual void RenderParts(eRenderMode p_Mode, BD_UINT32 p_Start, BD_UINT32 p_Length );
